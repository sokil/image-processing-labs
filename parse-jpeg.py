                ...
                while True:
                    ...
                    if b == b'\xFF':
                        ...
                        if nxt[0] == 0x00:
                            ...
                            # restart marker
                            offset = f.tell() - 2
                            length_since_last_rst = offset - last_rst_offset
                            print(f"    Restart marker RST{nxt[0]-0xD0} at offset {offset:08X}, "
                                  f"length since last RST: {length_since_last_rst} bytes")
                            last_rst_offset = offset + 2  # restart marker is 2 bytes
                            continue
                        else:
